...
# # suggestions = ""
# clause_prompt = "you discuss and answer anything about give code, review, suggestions, reference links & any topics about programming to answer questions. don't answer anything outside this domain. Just responde 'It's outside from my domain'"
...
#     try:
#         prompt = (
#             f"This is my code: {review_data_store['code']}. "
#             f"This is my code review: {review_data_store['review_content']}. "
#             f"This is the suggestions gave for the code: {review_data_store['suggestion_content']}. "
#             f"These are the reference links given for further study: {review_data_store['refer_links_content']}."
#             f"Study this code, code review and suggestions and reference links. Don't reply this."
#         )

#         clause_prompt = (
#             "Use the given code, review, suggestions, reference links & any topics about programming to answer questions. "
#             "Don't answer anything outside this domain. Just respond 'It's outside from my domain'."
#         )
...
#             {
#                 "role": "user",
#                 "parts": ["Use the above content to answer follow-up questions. Don't answer anything outside from this domain. If anything is asked outside the domain, respond with 'It's outside from my domain'."]
#             },
#             {
#                 "role": "model",
#                 "parts": ["Okay,"]
...
async def initiate_code(context: CodeReviewContext):
    try:
        ...
        # Update the initial prompt with the latest data
        initial_prompt = (
            f"This is my code: {review_data_store['code']}. "
            f"This is my code review: {review_data_store['review_content']}. "
            f"This is the suggestions given for the code: {review_data_store['suggestion_content']}. "
            f"These are the reference links given for further study: {review_data_store['refer_links_content']}. "
            "Study this code, code review, suggestions, and reference links. Don't reply to this."
        )
        
        global chat_history
        # Reset chat history and add the initial prompt
        chat_history = [
...
async def chat_endpoint(chat_request: ChatRequest):
    try:
        clause_prompt = (
            "You discuss and answer anything about the given code, review, suggestions, "
            "reference links, and any topics about programming to answer questions. "
            "Don't answer questions anything outside this domain. Just respond 'It's outside from my domain'."
            "here's the question:"
        )
